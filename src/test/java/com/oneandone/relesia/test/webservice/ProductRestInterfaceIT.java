...
public class ProductRestInterfaceIT {

	private final String RESOURCE_PATH = "products";
	private final String NEW_OBJECT_JSON = "{\"name\":\"NEWPRODUCTFORTEST\"}";
	...
	public void requestNewObjectCreation_thenCreationIsSuccesfull() throws ClientProtocolException, IOException {
		...
		// Then
		ProductEntity resource = RestTestUtil.retrieveResourceFromResponse(response,
				ProductEntity.class);
	...
	public void requestObjectUpdate_thenUpdateIsSuccesfull() throws ClientProtocolException, IOException {
		...
		resource = RestTestUtil.retrieveResourceFromResponse(response, ProductEntity.class);
		Assert.assertNotNull(resource);
