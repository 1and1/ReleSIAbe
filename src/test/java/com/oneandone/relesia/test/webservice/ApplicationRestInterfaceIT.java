...
public class ApplicationRestInterfaceIT {

	private final String RESOURCE_PATH = "applications";
	private final String NEW_OBJECT_JSON = "{\"name\":\"NEWAPPFORTEST\"," + "\"product\": {\"id\": 1},"
			+ "\"sourcePath\": \"NEWSOURCEPATHFORTEST\"," + "\"scm\": {\"id\": 1}," + "\"language\": {\"id\": 1},"
			+ "\"buildType\": {\"id\": 1}," + "\"releaseRepo\": {\"id\": 1},"
			+ "\"releaseLocation\": \"NEWURLFORTEST\"," + "\"snapshotLocation\": \"NEWLOCATIONFORTEST\""
			+ "}";
	...
	public void requestNewObjectCreation_thenCreationIsSuccesfull() throws ClientProtocolException, IOException {
		...
		// Then
		ApplicationEntity resource = RestTestUtil.retrieveResourceFromResponse(response, ApplicationEntity.class);
	...
	public void requestObjectUpdate_thenUpdateIsSuccesfull() throws ClientProtocolException, IOException {
		...
		resource = RestTestUtil.retrieveResourceFromResponse(response, ApplicationEntity.class);
