...
public class ProgrammingLanguageRestInterfaceIT {

	private final String RESOURCE_PATH = "prlangs";
	private final String NEW_OBJECT_JSON = "{\"name\":\"NEWLANGUAGEFORTEST\",\"version\":\"NEWVERSIONFORTEST\"}";
	...
	public void requestNewObjectCreation_thenCreationIsSuccesfull() throws ClientProtocolException, IOException {
		...
		// Then
		ProgrammingLanguageEntity resource = RestTestUtil.retrieveResourceFromResponse(response,
	...
	public void requestObjectUpdate_thenUpdateIsSuccesfull() throws ClientProtocolException, IOException {
		...
		resource = RestTestUtil.retrieveResourceFromResponse(response, ProgrammingLanguageEntity.class);
		Assert.assertNotNull(resource);
